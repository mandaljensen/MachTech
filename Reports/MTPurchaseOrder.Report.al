report 50001 "MT Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/MTPurchaseOrder.rdlc';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_PurchHeader; Format("Purchase Header"."Document Date", 0, '<year4>.<month,2>.<day,2>'))
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(HomePage; Format(CompanyInfo."Home Page"))
                        {
                        }
                        ...
                        column(Desc_PurchLineCaption; DescriptionTypeNoCaptionLbl)
                        {
                        }
                        ...
                        column(ExpectedReceiptDate; PurchLine."Expected Receipt Date")
                        {
                        }
    ...
    var
        ...
        Text004Lbl: Label 'Order %1', Comment = '%1 = Document No.';
        ...
        DescriptionTypeNoCaptionLbl: label 'Description / Type Number';
